        ...
        <li className="active">
          <div class="collapsible-header">
            ...
            <div class="collapsible-body">
              ...
              <span>Завдання - це там де не потрібно багато думати, щоб виконати задачу.</span> Завдання повинно бути простим, ясно сформульованим. Такі задачі продумуються завчасно, коли людина перебуває у високоусвідомленому стані, тому коли справа доходить до реалізації вона вже має алгоритм для їхнього  вирішення. Завдання можуть бути виконанні нашою "внутрішньою мавпочкою" без глибокої концентрації, майже механічно.    
              </p> 
            </div>
          </div>
        </li>
