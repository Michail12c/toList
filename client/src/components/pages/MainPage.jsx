   ...
   return(
    ...
    <h4 className = "top-title">
     ...
     <p className="title-main"><img src={image} alt="image"/>
       ...
       Одна з причин неефективності численних моделей тайм-менеджменту полягає в механічному підході до формулювання завдань, коли різні по пріоритету, типу та внутрішній складності задачі складаються в один блок, в результаті чого користувач опиняється перед непідйомною глибою незроблених справ, що дедалі більше пригнічує психіку та формує поведінку уникання. Людина розчаровується у своій здатності втілити задумане у життя, все більше прокрастинує та втрачає мотивацію.     
     </p>
